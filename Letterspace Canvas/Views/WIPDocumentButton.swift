    ...
    var body: some View {
                ...
                if shouldShowButtons {
                    HStack(spacing: 6) {
                        ...
                        Button(action: {
                            ...
                            // Notify that document list changed
                            NotificationCenter.default.post(
                                name: NSNotification.Name("DocumentListDidUpdate"), 
                                object: nil
                            )
                            
                            // Clear selection when removing on iPad
                            ...
                            ZStack {
                                Circle()
                                    // iPad: Use hover color when selected, Mac: Use hover color when hovered
                                    .fill((isIPad && isSelected) || isRemoveButtonHovered ? Color.red : Color.black)
                                    .frame(width: isIPad ? 26 : 15, height: isIPad ? 26 : 15) // Increased to 26x26 for iPad
        ...
        .simultaneousGesture(
            ...
            LongPressGesture(minimumDuration: 0.5)
                .onEnded { _ in
                    print("Long press detected on WIP iPad") // Debug print
